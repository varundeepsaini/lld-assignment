...
public class InteractiveDriver {
            ...
            try {
                ...
                switch (choice) {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        System.out.println("\nThank you for using Amazon Bestselling Books Analysis System!");
                        return;
                    default:
                        System.out.println("\nInvalid choice. Please select a number from 1-7.");
                }
    ...
    private static void countBooksByAuthor() {
        ...
        System.out.println("\nResult:");
        System.out.println("Author search: " + authorName);
    ...
    private static void priceOfBooksByAuthor() {
        ...
        if (authorBooks.isEmpty()) {
            ...
            for (Book book : authorBooks) {
                ...
                System.out.printf("%-40s $%d%n", title, book.getPrice());
